...
void Attention::multi_head_attention(
    ...
    #pragma acc parallel for collapse(2) private(val, cumulative) shared(y,num_heads,N,_head_dim,query,key,_scale,qk,value) schedule(dynamic) reduction(+:val,cumulative)
